...
class multiView:
    def __init__(self, vid_num=[0, 2, 4, 6], can_chan='can0', cap_res=[1280, 720], disp_res=(1920, 1080),
                 win_n='MultiView', can_filter=[{"can_id": 0x19FAA050, "can_mask": 0x1FFFFF00, "extended": True}]):
        self.vid = vid_num
        self.can_c = can_chan
...
def main():
    ...
    can_filter=[{"can_id": 0x19FAA050, "can_mask": 0x1FFFFF00, "extended": True}]
